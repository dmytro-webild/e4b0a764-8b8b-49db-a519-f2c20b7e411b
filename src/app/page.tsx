...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/crop-shot-cheese-cake_1301-642.jpg",
          alt: "Crop shot cheese cake",
        },
        {
          src: "http://img.b2bpic.net/free-photo/cup-tea-with-ny-cheesecake-with-berry-sauce_114579-2316.jpg",
          alt: "A cup of tea with NY cheesecake with berry sauce",
        },
        {
          src: "http://img.b2bpic.net/free-photo/sugar-powder-is-sprinkled-chocolate-pudding-glasses_140725-5079.jpg",
          alt: "Sugar powder is sprinkled over chocolate pudding glasses",
        },
        {
          src: "http://img.b2bpic.net/free-photo/cream-pastry-bag-lady-with-baking-tool_1157-47274.jpg",
          alt: "Cream in a pastry bag. Lady with a baking tool.",
        },
      ]}
      marqueeItems={[
        {
          type: "text",
          text: "Premium Belgian Chocolate",
        },
        {
          type: "text",
          text: "Handcrafted Gelato",
        },
        {
          type: "text",
          text: "Fresh Daily",
      ...
      bulletPoints={[
        {
          ...
          description: "Sourced from the best farms in Belgium and Italy.",
        },
        {
      ...
      features={[
        {
          ...
          description: "Authentic recipes redefined for modern palates.",
          buttonIcon: "Zap",
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        },
        {
          ...
          rating: 5,
          reviewCount: "95",
          imageSrc: "http://img.b2bpic.net/free-photo/leaves-kernels-around-present_23-2147886041.jpg",
        },
        {
          id: "3",
          brand: "Cadoro",
          name: "Chocolate Lampone",
          price: "12.50 AZN",
          rating: 5,
          reviewCount: "80",
          imageSrc: "http://img.b2bpic.net/free-photo/delectable-wafer-rolls-chocolate-coated-wafer-wooden-plate-marble_114579-84025.jpg",
        },
        {
          id: "4",
          brand: "Cadoro",
          ...
          rating: 4,
          reviewCount: "45",
          imageSrc: "http://img.b2bpic.net/free-photo/indulgent-chocolate-truffles-wrapped-ornate-paper-generated-by-ai_188544-17978.jpg",
        },
        {
          id: "5",
          brand: "Cadoro",
      ...
      testimonials={[
        {
          ...
          name: "Leyla M.",
          handle: "@leyla_foodie",
          testimonial: "The best gelato I have ever tasted in Baku. Simply divine!",
          rating: 5,
        ...
        },
        {
          ...
          name: "Elvin K.",
          handle: "@elvin_k",
          testimonial: "Fantastic Belgian chocolates. Perfect for gifting.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/young-woman-blue-wall-celebrates-birthday-holds-piece-cake-happy-bites-cake_343596-7527.jpg",
        },
        {
          id: "3",
          name: "Aydan S.",
          handle: "@aydan_sweet",
          testimonial: "Amazing variety and the quality is absolutely top-notch.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Rashad H.",
          handle: "@rashad_h",
          testimonial: "A must-visit for any dessert lover. Highly recommend!",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/curly-haired-beautiful-woman-bites-lips-looks-appetizing-piece-cake-with-raspberries-has-sweet-tooth-feels-temptation-eat-delicious-dessert-isolated-blue-background-sugar-addiction_273609-61590.jpg",
        },
        {
          id: "5",
          name: "Nigar A.",
          handle: "@nigar_dessert",
          testimonial: "Everything I tried was delicious. Will definitely be back.",
          rating: 5,
      ...
      faqs={[
        {
          ...
          content: "Yes, we offer delivery via Wolt throughout Baku.",
        },
        {
          id: "q2",
          title: "Are your chocolates Belgian?",
          content: "We use the finest Belgian chocolate for all our dark and milk collections.",
        },
        {
          id: "q3",
          title: "Can I visit the shop?",
          content: "Yes, we look forward to welcoming you to Cadoro for the full experience.",
        },
      ]}
      ...
      columns={[
        ...
        },
        {
          ...
          items: [
            {
              label: "Instagram",
              href: "https://www.instagram.com/cadoro.shop/",
            },
            {
              label: "Wolt",
              href: "https://wolt.com/en/aze/baku/venue/cadoro",
            },
          ],
        },
      ]}
